...
public class Testcase_retry {
	WebDriver driver;
	@Test(retryAnalyzer=retryanalyzer.Pgm16_RetryLogic.class)
	public void logintoAmazon()
	{
		...
		WebElement sign_in=driver.findElement(By.xpath("//output[@id='signInSubmit']"));
		sign_in.click();		
	}
